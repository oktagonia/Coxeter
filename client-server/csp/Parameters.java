...
/**
 * Represents a system of parameters
 */
public class Parameters extends ArrayList<Parameter> {
    ...
    /**
     * Return a vector of the values of all the unlocked
     * parameters
    ...
    /**
     * The number of unlocked parameters
    ...
    /**
     * Return a vector of length dimension() that
     * is 0 in all places except at index. Used for
     * differentiation.
     * @return a vector
     */
    ...
    /**
     * Create a new Parameters object from xml
     * @return Parameter
     */
